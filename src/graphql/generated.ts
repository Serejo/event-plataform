...
export type GetLessonBySlugQuery = { __typename?: 'Query', lesson?: {
    videoId: string; __typename?: 'Lesson', title: string, id: string, description?: string | null, teacher?: { __typename?: 'Teacher', avatarURL: string, bio: string, name: string } | null 
} | null };
